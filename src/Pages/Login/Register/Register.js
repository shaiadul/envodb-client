    ...
    return (
        <div className='row  g-3 row d-flex justify-content-center bg-register align-items-center mx-auto'>
            ...
            <div className="col-lg-7 text-center mx-auto">
                <img className='w-100 h-50 mx-auto' src="https://fmca.ae/wp-content/uploads/2019/11/inventory_management6.jpg" alt="" />
            </div>
            {/* form two */}
            <div className="col-lg-5">
            <div className='p-5 mx-auto w-100 registerForm text-center my-5'>
            <h1 style={{color: '#C7C11A'}}  className='text-center  fw-bolder'>REGISTER !</h1>
            {/* <Form > */}
